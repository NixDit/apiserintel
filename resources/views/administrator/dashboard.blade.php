            ...
            <div class="col-xl-3">
                ...
                <a href="javascript:;" class="card bg-info hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bold fs-2 mb-2 mt-5">+{{ $data->sale->count() }}</div>
                        <div class="fw-semibold text-white">Ventas</div>
                    </div>
                    <!--end::Body-->
                </a>
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bold fs-2 mb-2 mt-5">+{{ $data->product->count() }}</div>
                        <div class="fw-semibold text-gray-100">Productos</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bold fs-2 mb-2 mt-5">{{ $data->client->count() }}</div>
                        <div class="fw-semibold text-white">Clientes registrados</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fw-semibold text-white">Ingresos</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('metronic/assets/media/stock/900x600/42.png')">
                        ...
                        <div class="mb-10">
                            ...
                            <span class="me-2">Bienvenido al sistema
                            <br />
                            <span class="position-relative d-inline-block text-danger">
                                <a href="javascript:;" class="text-success opacity-75-hover">Serintel</a>
                                <!--begin::Separator-->
                                <span class="position-absolute opacity-15 bottom-0 start-0 border-4 border-success border-bottom w-100"></span>
                                <!--end::Separator-->
                            </span></span>Celular</div>
                            <!--end::Title-->
                            <!--begin::Action-->
                            <div class="text-center">
                                <a href='javascript:;' class="btn btn-sm btn-dark fw-bold" data-bs-toggle="modal" data-bs-target="#xkt_modal_upgrade_plan">Hola!</a>
                            </div>
                            <!--begin::Action-->
                        </div>
                        <!--begin::Wrapper-->
