        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="mb-13 text-center">
                    <h1 class="mb-3">Actualizar Marca</h1>
                ...
                <div class="card-body pt-5">
                    <!--begin::Form-->
                    <form id="kt_ecommerce_settings_general_form_update" class="form" action="{{  route('catalog.brand.update',[$data->brand->id])  }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <!--begin::Row-->
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="name" value="{{ $data->brand->name ?? '' }}" required placeholder="Escriba el nombre de la marca" autocomplete="off"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
