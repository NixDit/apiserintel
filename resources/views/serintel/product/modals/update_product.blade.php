        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="card-body pt-5">
                    ...
                    <form id="kt_ecommerce_settings_general_form_update" class="form" action="{{  route('products.update',[$data->product->id])  }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <!--begin::Input group-->
                        <!--end::Input group-->
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="name" value="{{ $data->product->name ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="supplier_code" value="{{ $data->product->supplier_code ?? '' }}" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="code" value="{{ $data->product->code ?? '' }}" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="0.01" class="form-control" name="cost" value="{{ $data->product->cost ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="0.01" class="form-control" name="retail_price" value="{{ $data->product->retail_price ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="0.01" class="form-control" name="wholesale_price" value="{{ $data->product->wholesale_price ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="0.01" class="form-control" name="special_price" value="{{ $data->product->special_price ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="0.01" class="form-control" name="super_special_price" value="{{ $data->product->super_special_price ?? '' }}" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                                        ...
                                        <div class="overflow-hidden flex-grow-1">
                                            <select name="line_id" class="form-select rounded-start-0" data-control="select2" data-placeholder="Selecciona una opción" required>
                                                ...
                                                @foreach ($data->lines as $line)
                                                    <option
                                                        @isset($data->product)
                                                            @if ($data->product->line_id == $line->id)
                                                            selected
                                                            @endif
                                                        @endisset
                                                        name="line_id"
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-5">
                                    ...
                                    <textarea class="form-control" name="description" aria-label="With textarea">{{ $data->product->description }}</textarea>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                        ...
                        <div class="d-flex flex-center flex-row-fluid pt-12">
                            ...
                            <button type="submit" data-kt-contacts-type="submit" class="btn btn-primary">
                                <span class="indicator-label">Editar producto</span>
